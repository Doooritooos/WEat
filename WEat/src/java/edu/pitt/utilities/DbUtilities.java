...
public class DbUtilities {
    ...
    public ResultSet getResultSet(String sql) throws SQLException {  
        try {
            ...
            Statement statement = conn.createStatement(); // the Statement class is used to check the syntax etc. of the sql statement
    ...
    public boolean executeQuery(String sql){
        try {
            ...
            statement.executeQuery(sql); // execute query
